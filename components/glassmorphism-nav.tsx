...
const navigation = siteContent.nav
...
export function GlassmorphismNav() {
  ...
  const scrollToSection = (href: string) => {
    if (href.startsWith("/")) {
      // This handles external route navigation if passed to this function by mistake,
      // but typically we render Links for routes.
  ...
  return (
    <>
      ...
      >
        {/* Main Navigation */}
        <div className="w-[95vw] max-w-xs md:max-w-[1400px] mx-auto">
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-4 py-3 md:px-6 md:py-2">
            <div className="flex items-center justify-between">
              ...
              >
                ...
                />
                <span className="ml-2 font-bold text-white text-lg md:text-xl tracking-tighter">
                  Westside Union
                </span>
              </Link>
