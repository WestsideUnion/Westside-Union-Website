export const siteContent = {
  ...
  about: {
    ...
    timeline: [
      { year: "2009", title: "Founded", description: "Founded by Kai Han (Jacky) Ho and Jerry Schuman. Time-zone advantage across Asia & North America." },
      { year: "2013", title: "Rebranding & Expansion", description: "CTR Strategy Inc. invested; rebranded as Westside Union Inc.; expanded into VFX, software/hardware, and 3D printing." },
      { year: "2014", title: "R&D & SaaS", description: "Joined Google Ignite; started R&D; Project BitChat (encrypted messenger) and Project BizApp." },
      { year: "2015", title: "Project Leap M", description: "Smart garments for real-time ECG monitoring + reporting (Bio Union)." },
      { year: "2016", title: "Project LEIA", description: "Interactive 3D hologram system for Crystal Galleria (Shanghai); began investing in startups." },
      { year: "2017", title: "Global Presence", description: "MEDICA Connected Health Forum panel; Bio Union founded in San Francisco." },
      { year: "2018", title: "Blockchain Leadership", description: "Founder invited as founding member of Taiwan Blockchain SRO; helped draft regulatory direction." },
      { year: "2025", title: "Westside Union Corp", description: "Founded in Toronto to expand Canada operations." },
    ],
  },
  services: [
    {
